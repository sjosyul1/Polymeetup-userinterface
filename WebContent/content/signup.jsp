...
<body>
	...
	<div class="container">
		<div class="jumbotron">
			<div>
				<h1>Welcome to ASU Polytechnic MeetUP Portal! User Signup</h1>
					...
					<div class="col-lg-6">
						<form id="myForm" method="post" class="bs-example form-horizontal"
							...
							<fieldset>
								...
								<div class="form-group">
									<label for="streetInput" class="col-lg-3 control-label">Street
										Address</label>
									<div class="col-lg-9">
										<input type="text" class="form-control" name="streetAddress"
											id="streetInput" placeholder="Street Address" />
									</div>
								</div>
								
								<div class="form-group">
									<label for="cityInput" class="col-lg-3 control-label">City
										</label>
									<div class="col-lg-9">
								...
								<div class="form-group">
									<label for="stateInput" class="col-lg-3 control-label">State
										</label>
									<div class="col-lg-9">
										<input type="text" class="form-control" name="stateName"
											id="stateInput" placeholder="State" />
									</div>
								</div>
								<div class="form-group">
									<label for="phoneInput" class="col-lg-3 control-label">Phone Number
										</label>
									<div class="col-lg-9">
								...
								<div class="form-group">
									<label for="countryInput" class="col-lg-3 control-label">Country
										</label>
									<div class="col-lg-9">
								...
								<div class="form-group">
									<label for="zipcodeInput" class="col-lg-3 control-label">ZipCode
										</label>
									<div class="col-lg-9">
