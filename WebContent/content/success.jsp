...
<body>
	...
	<div class="panel panel-success">
		...
		<div class="alert alert-dismissable alert-success">
              ...
              Now you can explore the MeetUPs!
            </div>
		</div>
	</div>
...
<div class="container">
		<div class="jumbotron">
			<div>
				<h1>ASU Polytechnic MeetUP Portal!</h1>			
			</div>

			<a class="btn btn-primary" href="content/createmeetup.jsp">Create a MeetUP</a>  
			<a class="btn btn-primary" href="content/showmeetups.jsp">Show Meetups </a>
			<a class="btn btn-primary" href="content/techblog.jsp">Browse TechBlogs </a>
		</div>
